...
<table id="carriculum_table_top">
	...
	<blockquote class="o-quote">
		<p class="o-quote-content o-quote-content--not-last">Wiege sagt: Feldwirkung statt Bauernregeln</p>
		<cite class="o-quote-source">Isa Meusel, ehemalige Weiterbildungsteilnehmerin (ISBB)</cite>
	</blockquote>
	...
	<table class="o-table">
		...
		<td class="o-table__cell">
			Supervisor - Deutsche Gesellschaft für Supervision e. V., Köln (DGSv)
		</td>
	</tr>
	<tr>
	<td class="o-table__cell o-table__cell--quiet">
...
<tr>
	...
	<tr>
		...
		<td class="o-table__cell">
			Arbeit in stationärer Therapieeinrichtung für Familien mit Suchterkrankung (Berlin)
		</td>
	</tr>
	<tr>
		<td class="o-table__cell o-table__cell--quiet">
		...
		<td class="o-table__cell">
			Diplom-Sozialarbeiter (Universität Siegen)
		</td>
	</tr>
</table>
</div>
