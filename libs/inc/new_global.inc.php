...
//
  ...
  $menue_list['de']['ueber_uns'][3]['label'] = "Sandra Schampel-Özcan";
  $menue_list['de']['ueber_uns'][3]['path'] = "schampel_oezcan.php";
  $menue_list['de']['ueber_uns'][3]['seite'] = "ueber_uns";
  $menue_list['de']['ueber_uns'][3]['subseite'] = "schampel_oezcan";
